...
// function question(title, options, correctAnswerIndex = 1) {
//   let user = Object.create(NewUser);
//   user.title = title;
...
// function Question(title, options, correctAnswerIndex = 1) {
//   let user = Object.create(Question);
//   user.title = title;
//   user.options = options;
//   user.correctAnswerIndex = correctAnswerIndex;
...
class Question {
  constructor(title, options, correctAnswerIndex = 1) {
    this.title = title;
  ...
  getCorrectAnswer() {
    return data.option[data.correctAnswerIndex];
  }
}
